...
plot2.d = lmer(MeanAmp ~ Race*Object*Trial + (Race*Object|Subject) + (1|Electrode:Subject), dat = dat)
...
dat$Trial.s = dat$Trial/38.4

plot2.d = lmer(MeanAmp ~ Race*Object*Trial.s + (Race*Object|Subject) + (1|Electrode:Subject), dat = dat)
...
dat$Object.e = NA
dat$Object.e[dat$Object == "gun"] = -1
dat$Object.e[dat$Object == "tool"] = 1

tot = lmer(MeanAmp ~ Race.e*Object.e*Trial.s + (Race.e*Object.e|Subject) + (1|Electrode:Subject), dat = dat)
```
...
# fit model to plot simple slopes
plot3.d = lmer(MeanAmp ~ Race*Object*TrialOrder + (Race*Object|Subject) + (1|Electrode:Subject), dat = trialOrderDat)
...
plot4.d = lmer(MeanAmp ~ Race*Object*TrialOrder.s + (Race*Object|Subject) + (1|Electrode:Subject), dat = trialOrderDat)
...
subord = lmer(MeanAmp ~ Race.e*Object.e*TrialOrder.s + (Race.e*Object.e|Subject) + (1|Electrode:Subject), dat = trialOrderDat)
```
...
# fit model to plot simple slopes
plot5.d = lmer(MeanAmp ~ Race*Object*TrialOrder.c + (Race*Object|Subject) + (1|Electrode:Subject), dat = trialOrderDat)
...
trialOrderDat$TrialOrder.c.s = trialOrderDat$TrialOrder.c/14

plot5.d = lmer(MeanAmp ~ Race*Object*TrialOrder.c.s + (Race*Object|Subject) + (1|Electrode:Subject), dat = trialOrderDat)
