...
### 4. Testing blocks to see more precisely where the race effect dissappears

I divided trials into 8 blocks (1-32, 33-64, 65-96, 97-128, 129-160, 161-192, 193-224, 225-256) and labeled them in reverse order (so that the last block is the reference).
